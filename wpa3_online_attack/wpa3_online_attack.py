...
class airgeddon_wacker(object):
	...
	def language_strings(self):
		self.arr = {
			...
			("PORTUGUESE", 2): "Iniciando wpa_supplicant personalizado...",
			("RUSSIAN", 2): "Запуск пользовательского wpa_supplicant...",
			("GREEK", 2): "Έναρξη προσαρμοσμένου wpa_supplicant...",
			("ITALIAN", 2): "Avvio di wpa_supplicant personalizzato...",
			...
			("PORTUGUESE", 3): "Erro personalizado wpa_supplicant",
			("RUSSIAN", 3): "Пользовательская ошибка wpa_supplicant",
			("GREEK", 3): "Προσαρμοσμένο σφάλμα wpa_supplicant",
			("ITALIAN", 3): "Errore wpa_supplicant personalizzato",
			("POLISH", 3): "Niestandardowy błąd wpa_supplicant",
			...
			("RUSSIAN", 4): "Естовый пароль: ",
			("GREEK", 4): "Κωδικός πρόσβασης δοκιμής: ",
			("ITALIAN", 4): "Password di prova: ",
			("POLISH", 4): "Hasło testowe: ",
			...
			("PORTUGUESE", 5): "Lançando ataque contra a rede WPA3",
			("RUSSIAN", 5): "Запуск атаки на сеть WPA3",
			("GREEK", 5): "Εκκίνηση επίθεσης κατά του δικτύου WPA3",
			("ITALIAN", 5): "Lancio dell'attacco contro la rete WPA3",
			...
			("GREEK", 6): "Βρέθηκε κωδικός πρόσβασης: ",
			("ITALIAN", 6): "Password trovata: ",
			("POLISH", 6): "Znaleziono hasło: ",
			...
			("RUSSIAN", 7): "Готовый словарь. пароль не найден",
			("GREEK", 7): "Τελειωμένο λεξικό. ο κωδικός δεν βρέθηκε",
			("ITALIAN", 7): "Dizionario finito. password non trovata",
			("POLISH", 7): "Gotowy słownik. nie znaleziono hasła",
			...
			("ITALIAN", 8): "Annotare la password trovata. La finestra si chiuderà dopo aver premuto il tasto",
